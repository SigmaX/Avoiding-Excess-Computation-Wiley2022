...
class IndividualProbeCSV():
    ...
    def __init__(self, csv_file):
        ...
        fieldnames = ['birth_id']
        fieldnames.extend(BalancePhenotype._fields)
        fieldnames.extend(['start_eval_time', 'stop_eval_time', 'fitness'])
    ...
    def __call__(self, next_individual):
        ...
        while True:
            ...
            self.csv_writer.writerow({
                    ...
                    "position": phenome.position,
                    "velocity": phenome.velocity,
                    "angle": phenome.angle,
                    "rotational_velocity": phenome.rotational_velocity,
